                ...
                <div>
                  {posting ? (
                    ...
                    <CustomButton
                      type='submit'
                      title='Post'
                      containerStyles='bg-[#10993A] text-white py-1 px-6 rounded-full font-semibold text-sm'
                    />
                  )}
                </div>
              </div>
                ...
                {friendRequest?.map(({ _id, requestFrom: from }) => (
                  <div key={_id} className='flex items-center justify-between'>
                    ...
                    <div className='flex gap-1'>
                      <CustomButton
                        title='Accept'
                        containerStyles='bg-[#10993A] text-xs text-white px-1.5 py-1 rounded-full'
                      />
                      <CustomButton
                        title='Deny'
                  ...
                  >
                    ...
                    <div className='flex gap-1'>
                      <button
                        ...
                        onClick={() => {}}
                      >
                        <BsPersonFillAdd size={20} className='text-[#10993A]' />
                      </button>
                    </div>
                  </div>
                ))}
